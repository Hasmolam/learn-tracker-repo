        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/" aria-current="page" class="<?= urlIS('/') ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-white/5 hover:text-white" ?>rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Home</a>
              <a href="/about" class="<?= urlIS('/about') ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-white/5 hover:text-white" ?>rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">About</a>
              <a href="/contact" class="<?= urlIS('/contact') ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-white/5 hover:text-white" ?>rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Contact</a>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
